...
```
ghcr.io/rouzbeh-abadi/chatbot-engine/engine:0.1.6
ghcr.io/rouzbeh-abadi/chatbot-engine/engine-langgraph:0.1.6
ghcr.io/rouzbeh-abadi/chatbot-engine/backend:0.1.6
ghcr.io/rouzbeh-abadi/chatbot-engine/frontend:0.1.6
```
